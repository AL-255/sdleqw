...
| 28 | `num_neg_5` | `-5` | ![](scripts/snaps/hp/num_neg_5.png) | ![](scripts/snaps/sdl/num_neg_5.png) | 0.0% |
| 29 | `num_neg_3p14` | `-3.14` | ![](scripts/snaps/hp/num_neg_3p14.png) | ![](scripts/snaps/sdl/num_neg_3p14.png) | 0.0% |
...
| 107 | `add_decimal` | `0.1+0.2` | ![](scripts/snaps/hp/add_decimal.png) | ![](scripts/snaps/sdl/add_decimal.png) | 0.0% |
...
| 110 | `add_neg_5_3` | `-5+3` | ![](scripts/snaps/hp/add_neg_5_3.png) | ![](scripts/snaps/sdl/add_neg_5_3.png) | 0.0% |
| 111 | `add_3_neg_5` | `3+-5` | ![](scripts/snaps/hp/add_3_neg_5.png) | ![](scripts/snaps/sdl/add_3_neg_5.png) | 0.0% |
| 112 | `add_long_decimal` | `1.234+5.678` | ![](scripts/snaps/hp/add_long_decimal.png) | ![](scripts/snaps/sdl/add_long_decimal.png) | 0.0% |
| 113 | `add_var_with_index` | `X1+X2` | ![](scripts/snaps/hp/add_var_with_index.png) | ![](scripts/snaps/sdl/add_var_with_index.png) | 0.0% |
| 114 | `add_var_const` | `X+1` | ![](scripts/snaps/hp/add_var_const.png) | ![](scripts/snaps/sdl/add_var_const.png) | 0.0% |
| 115 | `add_var_neg_const` | `X+-1` | ![](scripts/snaps/hp/add_var_neg_const.png) | ![](scripts/snaps/sdl/add_var_neg_const.png) | 0.0% |
| 116 | `add_PI_2` | `PI+2` | ![](scripts/snaps/hp/add_PI_2.png) | ![](scripts/snaps/sdl/add_PI_2.png) | 0.0% |
...
| 127 | `add_three_decimals` | `1.1+2.2+3.3` | ![](scripts/snaps/hp/add_three_decimals.png) | ![](scripts/snaps/sdl/add_three_decimals.png) | 0.0% |
| 128 | `add_neg_neg` | `-1+-2` | ![](scripts/snaps/hp/add_neg_neg.png) | ![](scripts/snaps/sdl/add_neg_neg.png) | 0.0% |
| 129 | `add_X_neg_Y` | `X+-Y` | ![](scripts/snaps/hp/add_X_neg_Y.png) | ![](scripts/snaps/sdl/add_X_neg_Y.png) | 0.0% |
...
| 134 | `add_ten_const` | `10+10` | ![](scripts/snaps/hp/add_ten_const.png) | ![](scripts/snaps/sdl/add_ten_const.png) | 0.0% |
...
| 139 | `add_X_neg_3` | `X+-3` | ![](scripts/snaps/hp/add_X_neg_3.png) | ![](scripts/snaps/sdl/add_X_neg_3.png) | 0.0% |
| 140 | `add_neg_X_5` | `-X+5` | ![](scripts/snaps/hp/add_neg_X_5.png) | ![](scripts/snaps/sdl/add_neg_X_5.png) | 0.0% |
...
| 147 | `sub_long` | `10-3-2` | ![](scripts/snaps/hp/sub_long.png) | ![](scripts/snaps/sdl/sub_long.png) | 0.0% |
| 148 | `sub_decimal` | `1.5-0.5` | ![](scripts/snaps/hp/sub_decimal.png) | ![](scripts/snaps/sdl/sub_decimal.png) | 0.0% |
| 149 | `sub_negative` | `-1-1` | ![](scripts/snaps/hp/sub_negative.png) | ![](scripts/snaps/sdl/sub_negative.png) | 0.0% |
| 150 | `sub_X_neg_Y` | `X--Y` | ![](scripts/snaps/hp/sub_X_neg_Y.png) | ![](scripts/snaps/sdl/sub_X_neg_Y.png) | 0.0% |
| 151 | `sub_5_X_3` | `5-X-3` | ![](scripts/snaps/hp/sub_5_X_3.png) | ![](scripts/snaps/sdl/sub_5_X_3.png) | 0.0% |
...
| 157 | `sub_PI_3` | `PI-3` | ![](scripts/snaps/hp/sub_PI_3.png) | ![](scripts/snaps/sdl/sub_PI_3.png) | 0.0% |
| 158 | `sub_X_X` | `X-X` | ![](scripts/snaps/hp/sub_X_X.png) | ![](scripts/snaps/sdl/sub_X_X.png) | 0.0% |
| 159 | `sub_a_a_a` | `A-A-A` | ![](scripts/snaps/hp/sub_a_a_a.png) | ![](scripts/snaps/sdl/sub_a_a_a.png) | 0.0% |
...
| 170 | `sub_neg_const` | `-3-X` | ![](scripts/snaps/hp/sub_neg_const.png) | ![](scripts/snaps/sdl/sub_neg_const.png) | 0.0% |
...
| 179 | `mul_neg` | `-2*3` | ![](scripts/snaps/hp/mul_neg.png) | ![](scripts/snaps/sdl/mul_neg.png) | 0.0% |
...
| 187 | `mul_const_const` | `10*10` | ![](scripts/snaps/hp/mul_const_const.png) | ![](scripts/snaps/sdl/mul_const_const.png) | 0.0% |
...
| 192 | `mul_X_neg_1` | `X*-1` | ![](scripts/snaps/hp/mul_X_neg_1.png) | ![](scripts/snaps/sdl/mul_X_neg_1.png) | 0.0% |
| 193 | `mul_neg_X` | `-X*2` | ![](scripts/snaps/hp/mul_neg_X.png) | ![](scripts/snaps/sdl/mul_neg_X.png) | 0.0% |
...
| 207 | `div_chain` | `1/2/3` | ![](scripts/snaps/hp/div_chain.png) | ![](scripts/snaps/sdl/div_chain.png) | 0.0% |
...
| 210 | `div_PI_2` | `PI/2` | ![](scripts/snaps/hp/div_PI_2.png) | ![](scripts/snaps/sdl/div_PI_2.png) | 0.0% |
...
| 213 | `div_X_neg_2` | `X/-2` | ![](scripts/snaps/hp/div_X_neg_2.png) | ![](scripts/snaps/sdl/div_X_neg_2.png) | 0.0% |
| 214 | `div_neg_X_5` | `-X/5` | ![](scripts/snaps/hp/div_neg_X_5.png) | ![](scripts/snaps/sdl/div_neg_X_5.png) | 0.0% |
...
| 222 | `div_var_const` | `X/10` | ![](scripts/snaps/hp/div_var_const.png) | ![](scripts/snaps/sdl/div_var_const.png) | 0.0% |
...
| 228 | `div_a_b_c` | `A/B/R` | ![](scripts/snaps/hp/div_a_b_c.png) | ![](scripts/snaps/sdl/div_a_b_c.png) | 0.0% |
| 229 | `div_xyz` | `x/y/z` | ![](scripts/snaps/hp/div_xyz.png) | ![](scripts/snaps/sdl/div_xyz.png) | 0.0% |
| 230 | `div_neg_a_b` | `-A/B` | ![](scripts/snaps/hp/div_neg_a_b.png) | ![](scripts/snaps/sdl/div_neg_a_b.png) | 0.0% |
...
| 240 | `pow_neg` | `X^-1` | ![](scripts/snaps/hp/pow_neg.png) | ![](scripts/snaps/sdl/pow_neg.png) | 0.0% |
...
| 251 | `pow_X_10` | `X^10` | ![](scripts/snaps/hp/pow_X_10.png) | ![](scripts/snaps/sdl/pow_X_10.png) | 0.0% |
| 252 | `pow_X_neg_2` | `X^-2` | ![](scripts/snaps/hp/pow_X_neg_2.png) | ![](scripts/snaps/sdl/pow_X_neg_2.png) | 0.0% |
...
| 259 | `pow_a_inv` | `a^-1` | ![](scripts/snaps/hp/pow_a_inv.png) | ![](scripts/snaps/sdl/pow_a_inv.png) | 0.0% |
...
| # | name | keys | x50ng (HP firmware) | sdleqw | diff |
|---|---|---|---|---|---|
| 261 | `sqrt_just` | `@` | ![](scripts/snaps/hp/sqrt_just.png) | ![](scripts/snaps/sdl/sqrt_just.png) | 0.3% |
| 262 | `sqrt_X_after` | `X@` | ![](scripts/snaps/hp/sqrt_X_after.png) | ![](scripts/snaps/sdl/sqrt_X_after.png) | 0.5% |
| 263 | `sqrt_then_X` | `@X` | ![](scripts/snaps/hp/sqrt_then_X.png) | ![](scripts/snaps/sdl/sqrt_then_X.png) | 0.0% |
| 264 | `sqrt_2_after` | `2@` | ![](scripts/snaps/hp/sqrt_2_after.png) | ![](scripts/snaps/sdl/sqrt_2_after.png) | 0.5% |
| 265 | `sqrt_3_after` | `3@` | ![](scripts/snaps/hp/sqrt_3_after.png) | ![](scripts/snaps/sdl/sqrt_3_after.png) | 0.5% |
| 266 | `sqrt_then_2` | `@2` | ![](scripts/snaps/hp/sqrt_then_2.png) | ![](scripts/snaps/sdl/sqrt_then_2.png) | 0.0% |
| 267 | `sqrt_then_4` | `@4` | ![](scripts/snaps/hp/sqrt_then_4.png) | ![](scripts/snaps/sdl/sqrt_then_4.png) | 0.0% |
| 268 | `sqrt_X_squared` | `@X^2` | ![](scripts/snaps/hp/sqrt_X_squared.png) | ![](scripts/snaps/sdl/sqrt_X_squared.png) | 0.0% |
| 269 | `sqrt_then_sum` | `@1+1` | ![](scripts/snaps/hp/sqrt_then_sum.png) | ![](scripts/snaps/sdl/sqrt_then_sum.png) | 0.2% |
| 270 | `sqrt_X_plus_Y` | `@X+Y` | ![](scripts/snaps/hp/sqrt_X_plus_Y.png) | ![](scripts/snaps/sdl/sqrt_X_plus_Y.png) | 0.0% |
| 271 | `sqrt_a_div_b` | `@A/B` | ![](scripts/snaps/hp/sqrt_a_div_b.png) | ![](scripts/snaps/sdl/sqrt_a_div_b.png) | 0.0% |
| 272 | `sqrt_X_plus_1` | `@X+1` | ![](scripts/snaps/hp/sqrt_X_plus_1.png) | ![](scripts/snaps/sdl/sqrt_X_plus_1.png) | 0.0% |
| 273 | `sqrt_PI` | `@PI` | ![](scripts/snaps/hp/sqrt_PI.png) | ![](scripts/snaps/sdl/sqrt_PI.png) | 0.0% |
| 274 | `sqrt_long` | `@VARIABLE` | ![](scripts/snaps/hp/sqrt_long.png) | ![](scripts/snaps/sdl/sqrt_long.png) | 0.0% |
| 275 | `sqrt_in_div` | `@4/2` | ![](scripts/snaps/hp/sqrt_in_div.png) | ![](scripts/snaps/sdl/sqrt_in_div.png) | 0.0% |
| 276 | `sqrt_R` | `@R` | ![](scripts/snaps/hp/sqrt_R.png) | ![](scripts/snaps/sdl/sqrt_R.png) | 0.0% |
| 277 | `sqrt_t` | `@t` | ![](scripts/snaps/hp/sqrt_t.png) | ![](scripts/snaps/sdl/sqrt_t.png) | 0.0% |
| 278 | `sqrt_after_n` | `@n` | ![](scripts/snaps/hp/sqrt_after_n.png) | ![](scripts/snaps/sdl/sqrt_after_n.png) | 0.0% |
| 279 | `sqrt_after_long_name` | `@ALPHA` | ![](scripts/snaps/hp/sqrt_after_long_name.png) | ![](scripts/snaps/sdl/sqrt_after_long_name.png) | 0.0% |
| 280 | `sqrt_after_minus` | `-@4` | ![](scripts/snaps/hp/sqrt_after_minus.png) | ![](scripts/snaps/sdl/sqrt_after_minus.png) | 0.0% |
...
| 285 | `nthroot_5_X` | `#5$rX` | ![](scripts/snaps/hp/nthroot_5_X.png) | ![](scripts/snaps/sdl/nthroot_5_X.png) | 0.5% |
| 286 | `nthroot_n_X` | `#n$rX` | ![](scripts/snaps/hp/nthroot_n_X.png) | ![](scripts/snaps/sdl/nthroot_n_X.png) | 0.5% |
| 287 | `nthroot_3_a` | `#3$ra` | ![](scripts/snaps/hp/nthroot_3_a.png) | ![](scripts/snaps/sdl/nthroot_3_a.png) | 0.4% |
...
| # | name | keys | x50ng (HP firmware) | sdleqw | diff |
|---|---|---|---|---|---|
| 291 | `paren_around_X` | `X(` | ![](scripts/snaps/hp/paren_around_X.png) | ![](scripts/snaps/sdl/paren_around_X.png) | 0.5% |
| 292 | `paren_around_5` | `5(` | ![](scripts/snaps/hp/paren_around_5.png) | ![](scripts/snaps/sdl/paren_around_5.png) | 0.5% |
| 293 | `paren_around_a_plus_b` | `A+B(` | ![](scripts/snaps/hp/paren_around_a_plus_b.png) | ![](scripts/snaps/sdl/paren_around_a_plus_b.png) | 0.9% |
| 294 | `paren_around_X_div_Y` | `X/Y(` | ![](scripts/snaps/hp/paren_around_X_div_Y.png) | ![](scripts/snaps/sdl/paren_around_X_div_Y.png) | 1.0% |
| 295 | `paren_double` | `X((` | ![](scripts/snaps/hp/paren_double.png) | ![](scripts/snaps/sdl/paren_double.png) | 0.8% |
| 296 | `paren_then_op` | `X(+1` | ![](scripts/snaps/hp/paren_then_op.png) | ![](scripts/snaps/sdl/paren_then_op.png) | 0.7% |
| 297 | `paren_around_sum` | `X+Y(` | ![](scripts/snaps/hp/paren_around_sum.png) | ![](scripts/snaps/sdl/paren_around_sum.png) | 0.8% |
| 298 | `paren_around_diff` | `X-Y(` | ![](scripts/snaps/hp/paren_around_diff.png) | ![](scripts/snaps/sdl/paren_around_diff.png) | 0.7% |
| 299 | `paren_around_pow` | `X^2(` | ![](scripts/snaps/hp/paren_around_pow.png) | ![](scripts/snaps/sdl/paren_around_pow.png) | 0.9% |
| 300 | `paren_around_decimal` | `3.14(` | ![](scripts/snaps/hp/paren_around_decimal.png) | ![](scripts/snaps/sdl/paren_around_decimal.png) | 0.8% |
| 301 | `paren_around_neg_X` | `-X(` | ![](scripts/snaps/hp/paren_around_neg_X.png) | ![](scripts/snaps/sdl/paren_around_neg_X.png) | 0.5% |
| 302 | `paren_X_div_2` | `X(/2` | ![](scripts/snaps/hp/paren_X_div_2.png) | ![](scripts/snaps/sdl/paren_X_div_2.png) | 0.9% |
| 303 | `paren_around_abc` | `ABC(` | ![](scripts/snaps/hp/paren_around_abc.png) | ![](scripts/snaps/sdl/paren_around_abc.png) | 1.0% |
| 304 | `paren_around_PI` | `PI(` | ![](scripts/snaps/hp/paren_around_PI.png) | ![](scripts/snaps/sdl/paren_around_PI.png) | 0.6% |
| 305 | `paren_around_long` | `VARIABLE(` | ![](scripts/snaps/hp/paren_around_long.png) | ![](scripts/snaps/sdl/paren_around_long.png) | 2.0% |

### Absolute value

| # | name | keys | x50ng (HP firmware) | sdleqw | diff |
|---|---|---|---|---|---|
| 306 | `abs_X` | `X|` | ![](scripts/snaps/hp/abs_X.png) | ![](scripts/snaps/sdl/abs_X.png) | 0.9% |
| 307 | `abs_5` | `5|` | ![](scripts/snaps/hp/abs_5.png) | ![](scripts/snaps/sdl/abs_5.png) | 0.7% |
| 308 | `abs_X_plus_Y` | `X+Y|` | ![](scripts/snaps/hp/abs_X_plus_Y.png) | ![](scripts/snaps/sdl/abs_X_plus_Y.png) | 1.1% |
| 309 | `abs_X_minus_5` | `X-5|` | ![](scripts/snaps/hp/abs_X_minus_5.png) | ![](scripts/snaps/sdl/abs_X_minus_5.png) | 1.0% |
| 310 | `abs_X_squared` | `X^2|` | ![](scripts/snaps/hp/abs_X_squared.png) | ![](scripts/snaps/sdl/abs_X_squared.png) | 1.2% |
| 311 | `abs_X_div_Y` | `X/Y|` | ![](scripts/snaps/hp/abs_X_div_Y.png) | ![](scripts/snaps/sdl/abs_X_div_Y.png) | 1.5% |
| 312 | `abs_PI` | `PI|` | ![](scripts/snaps/hp/abs_PI.png) | ![](scripts/snaps/sdl/abs_PI.png) | 0.9% |
| 313 | `abs_neg_X` | `-X|` | ![](scripts/snaps/hp/abs_neg_X.png) | ![](scripts/snaps/sdl/abs_neg_X.png) | 0.9% |
| 314 | `abs_long_name` | `VARIABLE|` | ![](scripts/snaps/hp/abs_long_name.png) | ![](scripts/snaps/sdl/abs_long_name.png) | 2.0% |
| 315 | `abs_a_plus_b` | `A+B|` | ![](scripts/snaps/hp/abs_a_plus_b.png) | ![](scripts/snaps/sdl/abs_a_plus_b.png) | 1.3% |

### Prefix functions

| # | name | keys | x50ng (HP firmware) | sdleqw | diff |
|---|---|---|---|---|---|
| 316 | `sin_X` | `X$s` | ![](scripts/snaps/hp/sin_X.png) | ![](scripts/snaps/sdl/sin_X.png) | 0.1% |
| 317 | `sin_2` | `2$s` | ![](scripts/snaps/hp/sin_2.png) | ![](scripts/snaps/sdl/sin_2.png) | 0.1% |
| 318 | `sin_PI` | `PI$s` | ![](scripts/snaps/hp/sin_PI.png) | ![](scripts/snaps/sdl/sin_PI.png) | 0.9% |
| 319 | `cos_X` | `X$c` | ![](scripts/snaps/hp/cos_X.png) | ![](scripts/snaps/sdl/cos_X.png) | 0.1% |
| 320 | `cos_2` | `2$c` | ![](scripts/snaps/hp/cos_2.png) | ![](scripts/snaps/sdl/cos_2.png) | 0.1% |
| 321 | `tan_X` | `X$T` | ![](scripts/snaps/hp/tan_X.png) | ![](scripts/snaps/sdl/tan_X.png) | 0.1% |
| 322 | `ln_X` | `X$n` | ![](scripts/snaps/hp/ln_X.png) | ![](scripts/snaps/sdl/ln_X.png) | 0.1% |
| 323 | `ln_e` | `e$n` | ![](scripts/snaps/hp/ln_e.png) | ![](scripts/snaps/sdl/ln_e.png) | 0.1% |
| 324 | `exp_X` | `X$X` | ![](scripts/snaps/hp/exp_X.png) | ![](scripts/snaps/sdl/exp_X.png) | 0.9% |
| 325 | `exp_neg_X` | `-X$X` | ![](scripts/snaps/hp/exp_neg_X.png) | ![](scripts/snaps/sdl/exp_neg_X.png) | 0.9% |
| 326 | `log_X` | `X$g` | ![](scripts/snaps/hp/log_X.png) | ![](scripts/snaps/sdl/log_X.png) | 0.1% |
| 327 | `log_10` | `10$g` | ![](scripts/snaps/hp/log_10.png) | ![](scripts/snaps/sdl/log_10.png) | 1.3% |

### Other

| # | name | keys | x50ng (HP firmware) | sdleqw | diff |
|---|---|---|---|---|---|
| 328 | `absfn_X` | `X$a` | ![](scripts/snaps/hp/absfn_X.png) | ![](scripts/snaps/sdl/absfn_X.png) | 1.1% |

### Prefix functions

| # | name | keys | x50ng (HP firmware) | sdleqw | diff |
|---|---|---|---|---|---|
| 329 | `sin_X_plus_Y` | `X+Y$s` | ![](scripts/snaps/hp/sin_X_plus_Y.png) | ![](scripts/snaps/sdl/sin_X_plus_Y.png) | 0.1% |
| 330 | `cos_X_plus_Y` | `X+Y$c` | ![](scripts/snaps/hp/cos_X_plus_Y.png) | ![](scripts/snaps/sdl/cos_X_plus_Y.png) | 0.1% |
| 331 | `sin_X_div_2` | `X/2$s` | ![](scripts/snaps/hp/sin_X_div_2.png) | ![](scripts/snaps/sdl/sin_X_div_2.png) | 2.1% |
| 332 | `cos_X_2` | `X^2$c` | ![](scripts/snaps/hp/cos_X_2.png) | ![](scripts/snaps/sdl/cos_X_2.png) | 0.5% |
| 333 | `ln_X_plus_1` | `X+1$n` | ![](scripts/snaps/hp/ln_X_plus_1.png) | ![](scripts/snaps/sdl/ln_X_plus_1.png) | 0.7% |
| 334 | `sin_5` | `5$s` | ![](scripts/snaps/hp/sin_5.png) | ![](scripts/snaps/sdl/sin_5.png) | 0.1% |
| 335 | `sin_neg_X` | `-X$s` | ![](scripts/snaps/hp/sin_neg_X.png) | ![](scripts/snaps/sdl/sin_neg_X.png) | 0.1% |
| 336 | `ln_2` | `2$n` | ![](scripts/snaps/hp/ln_2.png) | ![](scripts/snaps/sdl/ln_2.png) | 0.1% |
| 337 | `exp_2X` | `2*X$X` | ![](scripts/snaps/hp/exp_2X.png) | ![](scripts/snaps/sdl/exp_2X.png) | 1.2% |
| 338 | `sin_X_squared` | `X^2$s` | ![](scripts/snaps/hp/sin_X_squared.png) | ![](scripts/snaps/sdl/sin_X_squared.png) | 0.5% |
| 339 | `cos_X_squared` | `X^2$c` | ![](scripts/snaps/hp/cos_X_squared.png) | ![](scripts/snaps/sdl/cos_X_squared.png) | 0.5% |
| 340 | `tan_X_plus_PI` | `X+PI$T` | ![](scripts/snaps/hp/tan_X_plus_PI.png) | ![](scripts/snaps/sdl/tan_X_plus_PI.png) | 1.0% |
| 341 | `log_PI` | `PI$g` | ![](scripts/snaps/hp/log_PI.png) | ![](scripts/snaps/sdl/log_PI.png) | 0.9% |
| 342 | `ln_PI` | `PI$n` | ![](scripts/snaps/hp/ln_PI.png) | ![](scripts/snaps/sdl/ln_PI.png) | 0.7% |
| 343 | `exp_pi_x` | `PI*X$X` | ![](scripts/snaps/hp/exp_pi_x.png) | ![](scripts/snaps/sdl/exp_pi_x.png) | 1.4% |
| 344 | `sin_PI_2` | `PI/2$s` | ![](scripts/snaps/hp/sin_PI_2.png) | ![](scripts/snaps/sdl/sin_PI_2.png) | 2.2% |
| 345 | `cos_PI_2` | `PI/2$c` | ![](scripts/snaps/hp/cos_PI_2.png) | ![](scripts/snaps/sdl/cos_PI_2.png) | 2.1% |
| 346 | `sin_X_minus_1` | `X-1$s` | ![](scripts/snaps/hp/sin_X_minus_1.png) | ![](scripts/snaps/sdl/sin_X_minus_1.png) | 0.9% |
| 347 | `ln_VARIABLE` | `VARIABLE$n` | ![](scripts/snaps/hp/ln_VARIABLE.png) | ![](scripts/snaps/sdl/ln_VARIABLE.png) | 0.1% |
| 348 | `sin_then_paren_X` | `X$s(` | ![](scripts/snaps/hp/sin_then_paren_X.png) | ![](scripts/snaps/sdl/sin_then_paren_X.png) | 1.5% |
| 349 | `sin_X_times_2` | `X*2$s` | ![](scripts/snaps/hp/sin_X_times_2.png) | ![](scripts/snaps/sdl/sin_X_times_2.png) | 0.1% |
| 350 | `ln_X_X` | `X*X$n` | ![](scripts/snaps/hp/ln_X_X.png) | ![](scripts/snaps/sdl/ln_X_X.png) | 0.1% |
...
| 352 | `integ_0_to_1` | `$I0$r1$rX$rX` | ![](scripts/snaps/hp/integ_0_to_1.png) | ![](scripts/snaps/sdl/integ_0_to_1.png) | 1.3% |
| 353 | `integ_a_to_b` | `$Ia$rb$rX$rX` | ![](scripts/snaps/hp/integ_a_to_b.png) | ![](scripts/snaps/sdl/integ_a_to_b.png) | 1.3% |
| 354 | `integ_0_to_inf` | `$I0$rINF$rX$rX` | ![](scripts/snaps/hp/integ_0_to_inf.png) | ![](scripts/snaps/sdl/integ_0_to_inf.png) | 1.6% |
| 355 | `integ_doc` | `$I0$r1/X$rABS$r$rt` | ![](scripts/snaps/hp/integ_doc.png) | ![](scripts/snaps/sdl/integ_doc.png) | 2.0% |
| 356 | `integ_X2` | `$I0$r1$rX^2$rX` | ![](scripts/snaps/hp/integ_X2.png) | ![](scripts/snaps/sdl/integ_X2.png) | 1.5% |
| 357 | `integ_sin` | `$I0$rPI$rX$s$rX` | ![](scripts/snaps/hp/integ_sin.png) | ![](scripts/snaps/sdl/integ_sin.png) | 2.4% |
| 358 | `integ_cos` | `$I0$rPI$rX$c$rX` | ![](scripts/snaps/hp/integ_cos.png) | ![](scripts/snaps/sdl/integ_cos.png) | 2.3% |
| 359 | `integ_simple_2` | `$I1$r2$rX$rX` | ![](scripts/snaps/hp/integ_simple_2.png) | ![](scripts/snaps/sdl/integ_simple_2.png) | 1.3% |
| 360 | `integ_simple_3` | `$I0$r10$rX$rX` | ![](scripts/snaps/hp/integ_simple_3.png) | ![](scripts/snaps/sdl/integ_simple_3.png) | 1.3% |
| 361 | `integ_sub` | `$I0$r1$r2*X$rX` | ![](scripts/snaps/hp/integ_sub.png) | ![](scripts/snaps/sdl/integ_sub.png) | 1.3% |
| 362 | `integ_div` | `$I1$r2$r1/X$rX` | ![](scripts/snaps/hp/integ_div.png) | ![](scripts/snaps/sdl/integ_div.png) | 1.4% |
...
| 365 | `integ_abs` | `$I0$r1$rX|$rX` | ![](scripts/snaps/hp/integ_abs.png) | ![](scripts/snaps/sdl/integ_abs.png) | 2.3% |
| 366 | `integ_basic_t` | `$I0$rT$rX$rT` | ![](scripts/snaps/hp/integ_basic_t.png) | ![](scripts/snaps/sdl/integ_basic_t.png) | 1.2% |
| 367 | `integ_constant` | `$I0$r1$r1$rX` | ![](scripts/snaps/hp/integ_constant.png) | ![](scripts/snaps/sdl/integ_constant.png) | 1.1% |
...
| 372 | `integ_lo_X_hi_2X` | `$IX$r2*X$rX$rX` | ![](scripts/snaps/hp/integ_lo_X_hi_2X.png) | ![](scripts/snaps/sdl/integ_lo_X_hi_2X.png) | 1.2% |
| 373 | `integ_F_of_t` | `$I0$r1$rF$rt` | ![](scripts/snaps/hp/integ_F_of_t.png) | ![](scripts/snaps/sdl/integ_F_of_t.png) | 1.4% |
| 374 | `integ_lo_PI_hi_2PI` | `$IPI$r2*PI$rX$rX` | ![](scripts/snaps/hp/integ_lo_PI_hi_2PI.png) | ![](scripts/snaps/sdl/integ_lo_PI_hi_2PI.png) | 1.5% |
...
| 377 | `sum_squared` | `$Sk$r1$rn$rk^2` | ![](scripts/snaps/hp/sum_squared.png) | ![](scripts/snaps/sdl/sum_squared.png) | 2.3% |
| 378 | `sum_cubed` | `$Sk$r1$rn$rk^3` | ![](scripts/snaps/hp/sum_cubed.png) | ![](scripts/snaps/sdl/sum_cubed.png) | 2.3% |
| 379 | `sum_geom` | `$Sk$r0$rn$rX^k` | ![](scripts/snaps/hp/sum_geom.png) | ![](scripts/snaps/sdl/sum_geom.png) | 2.4% |
| 380 | `sum_long` | `$Si$r1$rN$ri` | ![](scripts/snaps/hp/sum_long.png) | ![](scripts/snaps/sdl/sum_long.png) | 1.5% |
| 381 | `sum_const` | `$Sk$r1$rn$r1` | ![](scripts/snaps/hp/sum_const.png) | ![](scripts/snaps/sdl/sum_const.png) | 1.5% |
| 382 | `sum_to_inf` | `$Sk$r0$rINF$rk` | ![](scripts/snaps/hp/sum_to_inf.png) | ![](scripts/snaps/sdl/sum_to_inf.png) | 1.9% |
| 383 | `sum_div` | `$Sk$r1$rn$r1/k` | ![](scripts/snaps/hp/sum_div.png) | ![](scripts/snaps/sdl/sum_div.png) | 2.4% |
| 384 | `sum_X_k` | `$Sk$r1$rn$rX*k` | ![](scripts/snaps/hp/sum_X_k.png) | ![](scripts/snaps/sdl/sum_X_k.png) | 1.7% |
| 385 | `sum_negative` | `$Sk$r1$rn$r-k` | ![](scripts/snaps/hp/sum_negative.png) | ![](scripts/snaps/sdl/sum_negative.png) | 1.4% |
| 386 | `sum_inv_k` | `$Si$r1$rn$r1/i` | ![](scripts/snaps/hp/sum_inv_k.png) | ![](scripts/snaps/sdl/sum_inv_k.png) | 2.3% |
| 387 | `sum_basic_two` | `$Sk$r2$r5$rk` | ![](scripts/snaps/hp/sum_basic_two.png) | ![](scripts/snaps/sdl/sum_basic_two.png) | 1.7% |
| 388 | `sum_func` | `$Sk$r1$rn$rk$s` | ![](scripts/snaps/hp/sum_func.png) | ![](scripts/snaps/sdl/sum_func.png) | 1.6% |
| 389 | `sum_polynomial` | `$Sk$r0$rn$rk^2+1` | ![](scripts/snaps/hp/sum_polynomial.png) | ![](scripts/snaps/sdl/sum_polynomial.png) | 2.9% |
| 390 | `sum_double` | `$Sk$r1$rn$rk*X` | ![](scripts/snaps/hp/sum_double.png) | ![](scripts/snaps/sdl/sum_double.png) | 1.7% |
...
| 392 | `deriv_X_X2` | `$PX$rX^2` | ![](scripts/snaps/hp/deriv_X_X2.png) | ![](scripts/snaps/sdl/deriv_X_X2.png) | 1.5% |
| 393 | `deriv_X_sin_X` | `$PX$rX$s` | ![](scripts/snaps/hp/deriv_X_sin_X.png) | ![](scripts/snaps/sdl/deriv_X_sin_X.png) | 2.2% |
...
| 398 | `deriv_X_PI` | `$PX$rPI` | ![](scripts/snaps/hp/deriv_X_PI.png) | ![](scripts/snaps/sdl/deriv_X_PI.png) | 1.3% |
| 399 | `deriv_X_X_plus_Y` | `$PX$rX+Y` | ![](scripts/snaps/hp/deriv_X_X_plus_Y.png) | ![](scripts/snaps/sdl/deriv_X_X_plus_Y.png) | 1.4% |
| 400 | `deriv_X_X_squared_plus_1` | `$PX$rX^2+1` | ![](scripts/snaps/hp/deriv_X_X_squared_plus_1.png) | ![](scripts/snaps/sdl/deriv_X_X_squared_plus_1.png) | 2.2% |
...
| 408 | `where_sin` | `X$s$WX$r0` | ![](scripts/snaps/hp/where_sin.png) | ![](scripts/snaps/sdl/where_sin.png) | 1.2% |
| 409 | `where_cos` | `X$c$WX$r0` | ![](scripts/snaps/hp/where_cos.png) | ![](scripts/snaps/sdl/where_cos.png) | 1.3% |
...
| 414 | `complex_neg_neg` | `-1$Z-1` | ![](scripts/snaps/hp/complex_neg_neg.png) | ![](scripts/snaps/sdl/complex_neg_neg.png) | 0.5% |
...
| 417 | `complex_a_b` | `A$ZB` | ![](scripts/snaps/hp/complex_a_b.png) | ![](scripts/snaps/sdl/complex_a_b.png) | 0.8% |
| 418 | `complex_X_squared_Y` | `X^2$ZY` | ![](scripts/snaps/hp/complex_X_squared_Y.png) | ![](scripts/snaps/sdl/complex_X_squared_Y.png) | 0.9% |
| 419 | `complex_neg_X_Y` | `-X$ZY` | ![](scripts/snaps/hp/complex_neg_X_Y.png) | ![](scripts/snaps/sdl/complex_neg_X_Y.png) | 0.6% |
...
| 422 | `uf_G_X_Y` | `G$FX,Y` | ![](scripts/snaps/hp/uf_G_X_Y.png) | ![](scripts/snaps/sdl/uf_G_X_Y.png) | 0.9% |
| 423 | `uf_H_a_b_c` | `H$FA,B,R` | ![](scripts/snaps/hp/uf_H_a_b_c.png) | ![](scripts/snaps/sdl/uf_H_a_b_c.png) | 0.9% |
...
| 426 | `uf_F_neg_X` | `F$F-X` | ![](scripts/snaps/hp/uf_F_neg_X.png) | ![](scripts/snaps/sdl/uf_F_neg_X.png) | 0.7% |
...
| 429 | `uf_F_decimal` | `F$F3.14` | ![](scripts/snaps/hp/uf_F_decimal.png) | ![](scripts/snaps/sdl/uf_F_decimal.png) | 0.9% |
| 430 | `uf_F_long_arg` | `F$FVARIABLE` | ![](scripts/snaps/hp/uf_F_long_arg.png) | ![](scripts/snaps/sdl/uf_F_long_arg.png) | 1.9% |
...
| 438 | `edit_arrow_left` | `5+3$l` | ![](scripts/snaps/hp/edit_arrow_left.png) | ![](scripts/snaps/sdl/edit_arrow_left.png) | 0.6% |
| 439 | `edit_arrow_right` | `5+3$r` | ![](scripts/snaps/hp/edit_arrow_right.png) | ![](scripts/snaps/sdl/edit_arrow_right.png) | 0.7% |
| 440 | `edit_arrow_up` | `5+3$u` | ![](scripts/snaps/hp/edit_arrow_up.png) | ![](scripts/snaps/sdl/edit_arrow_up.png) | 0.6% |
| 441 | `edit_arrow_down` | `5+3$k` | ![](scripts/snaps/hp/edit_arrow_down.png) | ![](scripts/snaps/sdl/edit_arrow_down.png) | 0.6% |
| 442 | `edit_two_arrows` | `5+3$l$l` | ![](scripts/snaps/hp/edit_two_arrows.png) | ![](scripts/snaps/sdl/edit_two_arrows.png) | 0.6% |
| 443 | `edit_three_arrows` | `5+3$l$l$l` | ![](scripts/snaps/hp/edit_three_arrows.png) | ![](scripts/snaps/sdl/edit_three_arrows.png) | 0.6% |
| 444 | `edit_inside_div` | `5/3$u` | ![](scripts/snaps/hp/edit_inside_div.png) | ![](scripts/snaps/sdl/edit_inside_div.png) | 0.3% |
| 445 | `edit_inside_pow` | `X^2$u` | ![](scripts/snaps/hp/edit_inside_pow.png) | ![](scripts/snaps/sdl/edit_inside_pow.png) | 0.5% |
| 446 | `edit_double_bksp` | `12$b$b` | ![](scripts/snaps/hp/edit_double_bksp.png) | ![](scripts/snaps/sdl/edit_double_bksp.png) | 0.0% |
| 447 | `edit_clr_after` | `5+3$K` | ![](scripts/snaps/hp/edit_clr_after.png) | ![](scripts/snaps/sdl/edit_clr_after.png) | 0.3% |
| 448 | `edit_clr_all` | `5+3$L` | ![](scripts/snaps/hp/edit_clr_all.png) | ![](scripts/snaps/sdl/edit_clr_all.png) | 0.3% |
...
| 451 | `edit_5_3_two_arrows` | `5*3$u` | ![](scripts/snaps/hp/edit_5_3_two_arrows.png) | ![](scripts/snaps/sdl/edit_5_3_two_arrows.png) | 0.5% |
| 452 | `edit_complex_seq` | `5+X*2-3` | ![](scripts/snaps/hp/edit_complex_seq.png) | ![](scripts/snaps/sdl/edit_complex_seq.png) | 1.2% |
| 453 | `edit_replace_inside` | `5+3$lY` | ![](scripts/snaps/hp/edit_replace_inside.png) | ![](scripts/snaps/sdl/edit_replace_inside.png) | 0.4% |
| 454 | `edit_arrow_through_div` | `1/2$u` | ![](scripts/snaps/hp/edit_arrow_through_div.png) | ![](scripts/snaps/sdl/edit_arrow_through_div.png) | 0.3% |
| 455 | `edit_arrow_inside_sqrt` | `@X$l` | ![](scripts/snaps/hp/edit_arrow_inside_sqrt.png) | ![](scripts/snaps/sdl/edit_arrow_inside_sqrt.png) | 0.5% |
| 456 | `edit_arrow_inside_paren` | `X(+1$l` | ![](scripts/snaps/hp/edit_arrow_inside_paren.png) | ![](scripts/snaps/sdl/edit_arrow_inside_paren.png) | 0.6% |
| 457 | `edit_after_func` | `X$s$l` | ![](scripts/snaps/hp/edit_after_func.png) | ![](scripts/snaps/sdl/edit_after_func.png) | 0.1% |
...
| 462 | `nav_simple_left` | `5+3$l$l` | ![](scripts/snaps/hp/nav_simple_left.png) | ![](scripts/snaps/sdl/nav_simple_left.png) | 0.6% |
| 463 | `nav_up_in_div` | `1/2$u$u` | ![](scripts/snaps/hp/nav_up_in_div.png) | ![](scripts/snaps/sdl/nav_up_in_div.png) | 1.1% |
| 464 | `nav_down_in_div` | `1/2$k$k` | ![](scripts/snaps/hp/nav_down_in_div.png) | ![](scripts/snaps/sdl/nav_down_in_div.png) | 0.3% |
| 465 | `nav_around_pow` | `X^2$u$k` | ![](scripts/snaps/hp/nav_around_pow.png) | ![](scripts/snaps/sdl/nav_around_pow.png) | 0.5% |
| 466 | `nav_around_sqrt` | `@X$u` | ![](scripts/snaps/hp/nav_around_sqrt.png) | ![](scripts/snaps/sdl/nav_around_sqrt.png) | 0.5% |
| 467 | `nav_in_func` | `X$s$k` | ![](scripts/snaps/hp/nav_in_func.png) | ![](scripts/snaps/sdl/nav_in_func.png) | 0.1% |
| 468 | `nav_in_func_args` | `F$FX,Y$l` | ![](scripts/snaps/hp/nav_in_func_args.png) | ![](scripts/snaps/sdl/nav_in_func_args.png) | 0.8% |
| 469 | `nav_around_paren` | `X+Y($u` | ![](scripts/snaps/hp/nav_around_paren.png) | ![](scripts/snaps/sdl/nav_around_paren.png) | 0.8% |
| 470 | `nav_through_complex` | `3$Z4$l$r` | ![](scripts/snaps/hp/nav_through_complex.png) | ![](scripts/snaps/sdl/nav_through_complex.png) | 0.7% |
| 471 | `nav_in_integ` | `$I0$rX$rX$rX$l` | ![](scripts/snaps/hp/nav_in_integ.png) | ![](scripts/snaps/sdl/nav_in_integ.png) | 1.0% |
| 472 | `nav_in_sum` | `$Sk$r1$rn$rk$l` | ![](scripts/snaps/hp/nav_in_sum.png) | ![](scripts/snaps/sdl/nav_in_sum.png) | 1.3% |
| 473 | `nav_through_long_expr` | `5+3*4$l` | ![](scripts/snaps/hp/nav_through_long_expr.png) | ![](scripts/snaps/sdl/nav_through_long_expr.png) | 0.9% |
| 474 | `nav_after_left` | `5+3$l` | ![](scripts/snaps/hp/nav_after_left.png) | ![](scripts/snaps/sdl/nav_after_left.png) | 0.6% |
| 475 | `nav_after_right` | `5+3$r` | ![](scripts/snaps/hp/nav_after_right.png) | ![](scripts/snaps/sdl/nav_after_right.png) | 0.7% |
...
| 478 | `nav_in_neg` | `-5$u` | ![](scripts/snaps/hp/nav_in_neg.png) | ![](scripts/snaps/sdl/nav_in_neg.png) | 0.3% |
| 479 | `nav_back_to_root` | `X+Y+Z$u$u$u` | ![](scripts/snaps/hp/nav_back_to_root.png) | ![](scripts/snaps/sdl/nav_back_to_root.png) | 1.2% |
...
| 482 | `nav_nested_div_up` | `1/X+Y$u` | ![](scripts/snaps/hp/nav_nested_div_up.png) | ![](scripts/snaps/sdl/nav_nested_div_up.png) | 0.3% |
| 483 | `nav_after_paren_wrap` | `X+Y($u` | ![](scripts/snaps/hp/nav_after_paren_wrap.png) | ![](scripts/snaps/sdl/nav_after_paren_wrap.png) | 0.8% |
| 484 | `nav_in_abs` | `X|$u` | ![](scripts/snaps/hp/nav_in_abs.png) | ![](scripts/snaps/sdl/nav_in_abs.png) | 1.1% |
| 485 | `nav_in_complex` | `5$Z4$u` | ![](scripts/snaps/hp/nav_in_complex.png) | ![](scripts/snaps/sdl/nav_in_complex.png) | 0.7% |
| 486 | `nav_in_two_arg_func` | `F$FX,Y$l` | ![](scripts/snaps/hp/nav_in_two_arg_func.png) | ![](scripts/snaps/sdl/nav_in_two_arg_func.png) | 0.8% |
| 487 | `nav_in_three_arg_func` | `F$FX,Y,Z$l` | ![](scripts/snaps/hp/nav_in_three_arg_func.png) | ![](scripts/snaps/sdl/nav_in_three_arg_func.png) | 1.0% |
| 488 | `nav_after_userfunc` | `F$FX,Y$r` | ![](scripts/snaps/hp/nav_after_userfunc.png) | ![](scripts/snaps/sdl/nav_after_userfunc.png) | 1.2% |
| 489 | `nav_in_pow_after_arrows` | `X^2$u$k` | ![](scripts/snaps/hp/nav_in_pow_after_arrows.png) | ![](scripts/snaps/sdl/nav_in_pow_after_arrows.png) | 0.5% |
| 490 | `nav_complex_path` | `1+2*3$u$u$k` | ![](scripts/snaps/hp/nav_complex_path.png) | ![](scripts/snaps/sdl/nav_complex_path.png) | 0.9% |
...
| 502 | `auto_2X_plus_Y` | `2X+Y` | ![](scripts/snaps/hp/auto_2X_plus_Y.png) | ![](scripts/snaps/sdl/auto_2X_plus_Y.png) | 0.7% |
...
| 507 | `doc_user_guide_arith` | `5*1+1/7.5$r/@3-2^3` | ![](scripts/snaps/hp/doc_user_guide_arith.png) | ![](scripts/snaps/sdl/doc_user_guide_arith.png) | 2.5% |
| 508 | `doc_user_guide_algebra` | `2*L*@1+X/R$r/R+y$r+2*L/b` | ![](scripts/snaps/hp/doc_user_guide_algebra.png) | ![](scripts/snaps/sdl/doc_user_guide_algebra.png) | 2.1% |
| 509 | `doc_user_guide_greek` | `2/@3$rL+e^-Mu*LNX+2*Mu*Y$r/THETA^1/3` | ![](scripts/snaps/hp/doc_user_guide_greek.png) | ![](scripts/snaps/sdl/doc_user_guide_greek.png) | 4.8% |
| 510 | `doc_pythagorean` | `@A^2+B^2` | ![](scripts/snaps/hp/doc_pythagorean.png) | ![](scripts/snaps/sdl/doc_pythagorean.png) | 2.0% |
| 511 | `doc_sin_cos_sq` | `X$s^2+X$c^2` | ![](scripts/snaps/hp/doc_sin_cos_sq.png) | ![](scripts/snaps/sdl/doc_sin_cos_sq.png) | 2.9% |
| 512 | `doc_quadratic` | `A*X^2+B*X+R` | ![](scripts/snaps/hp/doc_quadratic.png) | ![](scripts/snaps/sdl/doc_quadratic.png) | 1.9% |
| 513 | `doc_simple_geom` | `PI*R^2` | ![](scripts/snaps/hp/doc_simple_geom.png) | ![](scripts/snaps/sdl/doc_simple_geom.png) | 0.3% |
| 514 | `doc_volume` | `4/3*PI*R^3` | ![](scripts/snaps/hp/doc_volume.png) | ![](scripts/snaps/sdl/doc_volume.png) | 1.3% |
| 515 | `doc_simple_log` | `X$n+Y$n` | ![](scripts/snaps/hp/doc_simple_log.png) | ![](scripts/snaps/sdl/doc_simple_log.png) | 2.0% |
